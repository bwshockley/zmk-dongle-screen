...
lv_obj_t *zmk_display_status_screen()
{
    ...
    lv_obj_align(zmk_widget_output_status_obj(&output_status_widget), LV_ALIGN_TOP_RIGHT, 50, 20);
#endif
    ...
    lv_obj_align(zmk_widget_wpm_status_obj(&wpm_status_widget), LV_ALIGN_TOP_LEFT, 25, 22);
#endif
    ...
    lv_obj_align(zmk_widget_hid_indicators_obj(&hid_indicators_widget), LV_ALIGN_LEFT_MID, 20, 30);
#endif
/*
#if CONFIG_DONGLE_SCREEN_LAYER_ACTIVE
    zmk_widget_layer_roller_init(&layer_roller_widget, screen);
    lv_obj_align(zmk_widget_layer_roller_obj(&layer_roller_widget), LV_ALIGN_LEFT_MID, 0, 0);
#endif
*/
